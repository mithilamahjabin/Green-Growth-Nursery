        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" action="{{route('place.order')}}" method="post" >
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" name="phoneNumber" placeholder="Enter Phone_No" value="" required >
            <div class="invalid-feedback">
            ...
            <hr class="mb-4">
            <button style="background-color: green" class="btn btn-primary btn-lg btn-block" type="submit">Continue to checkout</button>
          </form>

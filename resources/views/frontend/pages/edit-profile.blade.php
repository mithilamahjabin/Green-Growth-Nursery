...
<div class="container">
    ...
    <div class="row">
        ...
        <ul style="background-color: green" class="nav nav-tabs nav-product-tabs">
            ...
            <li><a style="background-color: green" data-toggle="tab" style="text-align: center;">Edit rofile</a></li>
...
<br> </br>
        ...
        <form class="form" action="{{route('customer.update',auth('customer')->user()->id)}}" method="post" enctype="multipart/form-data">
                ...
                <button style="background-color: green" type="submit" class="btn btn-primary">Update</button>
            </form>

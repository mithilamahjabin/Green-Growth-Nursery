...
@section('content')
    ...
    <div id="productReport">
        ...
        <h5 style="text-align: center"> Green Growth Nursery</h5>
        <p class="mb-0" style="text-align: center"> Email: nur.mithila@gmail.com
        </p>
        <p style="text-align: center"> Phone: 01646909848
        </p>

            ...
            <tbody>
                @foreach ($productsCollection as $key => $product)
                    <tr>
                        ...
                        <td>
                            <img style="width:60px; height:80px" src="{{ url('/uploads/products/' . $product->image) }}"
                                alt="">
                        </td>
                        <td>{{ $product->price }}</td>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href="{{ route('product.delete', $product->id) }}"onclick="return confirm('Are you sure to Delete?')">delete</a>

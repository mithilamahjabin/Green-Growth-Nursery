...
@section('content')
    ...
    <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input value="{{ $product->name }}" type="text" class="form-control" required name="product_name"
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="product_image" placeholder="Enter Product image">
        </div>

        <div class="form-group">
            <label for="">Enter Price</label>
            <input value="{{ $product->price }}" min='100' type="number" class="form-control" required
                name="product_price" placeholder="Enter Product Price">
        </div>
        <div class="form-group">
            <label for="">Enter Stock</label>
            <input value="{{ $product->quantity }}" min='10' type="number" class="form-control" required
